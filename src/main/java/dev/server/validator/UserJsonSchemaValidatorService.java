...
public class UserJsonSchemaValidatorService extends JsonSchemaValidatorServiceBase
{
    static UserJsonSchemaValidatorService instance;

    static {
        instance = new UserJsonSchemaValidatorService();
        instance.setJsonSchemaPath("schemas/user.json");
        instance.loadSchema(UserJsonSchemaValidatorService.class);
    }
